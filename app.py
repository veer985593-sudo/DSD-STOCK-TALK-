...
================================================================================
Generated: {timestamp}
Source: Stock Research AssistantOVERALL RATING: {data.get('overall_rating', 'N/A')}
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        st.subheader("🔍 Search Stock")
        symbol = st.text_input(
            "Enter Stock Symbol",    "Enter Stock Symbol",
...
def render_fundamental_analysis(symbol: str):
    ...
    try:
        ...
        with col1:
            ...
            | Metric | Value |
            |--------|-------|
            | P/E Ratio | {val.get('pe_ratio', 'N/A')} || Forward P/E | {val.get('forward_pe', 'N/A')} |
        ...
        col1, col2 = st.columns([1, 3])
        with col1:
            st.download_button(data=report_text,
...
def render_institutional(symbol: str):
    ...
    try:
        ...
        with col2:
            ...
            with st.spinner("Fetching deals..."):deals_data = json.loads(get_bulk_block_deals.run(symbol))
